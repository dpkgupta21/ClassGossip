package com.classgossip.navigationresidemenu;
 ...
 */
public class ResideMenuSecond extends FrameLayout {
    ...
    private void initViews(Context context) {
        ...
        inflater.inflate(R.layout.residemenu_second, this);
      ...
      //  ((TextView) viewHeader.findViewById(R.id.txt_name)).setText(Utils.getUserName(context));
